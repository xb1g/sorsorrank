...
1. [PRD](01-prd.md) - what we are building and why.
2. [Viral Growth Plan](02-viral-growth.md) - how the app spreads without becoming campaign propaganda.
...
8. [Legal Risk Hardening Review](07-legal-risk-hardening.md) - critical launch blockers and conservative compliance defaults.
9. [Backend Implementation Note](08-backend-implementation.md) - Supabase schema, Edge Functions, ranking, retention, and admin safety choices.
